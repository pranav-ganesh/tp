...
public class EditCommandParser implements Parser<EditCommand> {
    ...
    public EditCommand parse(String args) throws ParseException {
        ...
        if (argMultimap.getValue(PREFIX_INTERESTS).isPresent()) {
            editPersonDescriptor.setInterests(ParserUtil.parseInterests(argMultimap.getValue(PREFIX_INTERESTS).get()));
        }
